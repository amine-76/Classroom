public class Table  {
  ...
  public PShape init(){
      ...
      PShape surface = monCube(250,25,310,texture_surface);
      PShape partiedroite = monCube(250,250,25,texture_noire); 
      PShape partieGauche = monCube(250,250,25,texture_noire);
      PShape partieface = monCube(220,250,25,texture_noire);
      
      partiedroite.translate(0,250/2,250/2); 
      partieGauche.translate(0,250/2,-250/2);
      partieface.translate(250/2, 0, 250/2); 
      partieface.rotateZ(HALF_PI);
      partieface.rotateY(HALF_PI);
