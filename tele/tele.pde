public class Tele {
    ...
    PShape init(){
        ...
        PShape partieEcran = monCube(20,400,700,texture_tele); 
        PShape pied = monCube(200,50,300,texture_tele);  
        PShape composant1 = monCube(30,500,30,texture_tele); 

        //transformation
        composant1.translate(30, 400, 0);
